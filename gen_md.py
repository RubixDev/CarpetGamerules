...
SETTINGS_FILE = 'src/main/java/de/rubixdev/carpetgamerules/CarpetGamerulesSettings.java'
LANGUAGE_FILE = f'versions/{main_version}/build/resources/main/assets/carpetgamerules/lang/en_us.json'
MAIN_CATEGORY = 'GAMERULE'
...
for k, v in descriptions_raw.items():
    rule_name = (
        re.compile(r'carpetgamerules\.rule\.(\w+)\.(?:desc|extra\.\d+|additional)')
        .search(k)
        .group(1)
    )
