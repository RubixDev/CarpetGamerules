...
with open('src/main/java/de/rubixdev/carpetgamerules/CarpetGamerulesServer.java', 'r') as server_file:
    content = server_file.read()
    old_version = content.split('String VERSION = "')[1].split('";\n')[0]

with open('src/main/java/de/rubixdev/carpetgamerules/CarpetGamerulesServer.java', 'w') as server_file:
